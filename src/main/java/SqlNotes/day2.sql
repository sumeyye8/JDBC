...
-- NOT NULL --> Bir sutunun NULL içermemesini yani boş olmamasını sağlar. NOT NULL kısıtlaması için CONSTRAINT ismi tanımlanmaz. Bu kısıtlama veri türünden hemen sonra yerleştirilir
