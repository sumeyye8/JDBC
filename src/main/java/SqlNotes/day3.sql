...
--Parent tabloda olmayan id ile child tabloya ekleme yapamayızERT INTO  adresler VALUES()
...
-- PRIMARY KEY'den sonra FOREIGN KEY ataması
...
-- PRIMARY KEY'deki CONSTRAINT'i silme
alter table ogrenciler DROP CONSTRAINT ogrenci_adres_id_fkey;	--ogrenci adreste yazan foreign key ismi
...
-- Between belirttiginiz 2 veri arasındaki bilgileri listeler 
-- Between de belirttigimiz değerlerde listelemeye dahildir
...
/*
    AND (ve): Belirtilen şartların her ikisi de gerçekleşiyorsa o kayıt listelenir
