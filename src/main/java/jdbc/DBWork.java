...
public class DBWork {
    ...
    public Connection connect_to_db(String dbName, String user, String password) throws ClassNotFoundException {
        Connection con = null;
        try {
    ...
    public void createTable(Connection con, String tableName){
        ...
        try{
                String query = "CREATE TABLE " +tableName+ "(employeeId SERIAL, name VARCHAR(200), email VARCHAR(200), salary INTEGER, PRIMARY KEY(employeeId))";
