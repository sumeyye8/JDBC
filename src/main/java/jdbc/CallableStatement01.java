...
public class CallableStatement01 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        // 2. Step: Fonksiyonu calistir
        st.execute(sql1);

        // 3. Step: Fonksiyonu cagir
        ...
        // 4. Step: Return icin registerOutParameter() methodunu, parametreler icin set() methodlarindan uygun olanlari kullan
        cst1.registerOutParameter(1, Types.NUMERIC);
        cst1.setInt(2, 15);
        cst1.setInt(3, 25);

        // 5. Step: Calistirmak icin execute() methodu kullan
        cst1.execute();

        // 6. Step: Sonucu cagırmak icin return data tipine gore "get" methodlarindan uygun olani kullan
